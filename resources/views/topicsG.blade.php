                                    ...
                                    @foreach ($topics as $topic)          
                                        ...
                                        <div  class="row"  style="margin-bottom: 10px;padding-bottom: 10px; min-height: 120px; border: 1px solid #F2E7E5;border-radius: 5px;" class="border border-danger"  >
                                            ...
                                            <div class="col-12 col-md-12"  >
                                                ...
                                                <li><a  target="_blank"  href="/p/{{ $topic->user_code }}/{{ $topic->name }}"><i class="icon-user"></i> {{ $topic->name }}</a></li>
            ...
            $(".search-input").typeahead({
                ...
                templates: {
                    ...
                    suggestion: function (data) {
                        ...
                        return `
                                <a href="/t/` +  data.url + `" class="list-group-item list-group-item-action flex-column align-items-start ">
