...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        paymonthly: function paymonthly() {

            Nova.request().post('/nova-vendor/payments/paymonthly').then(function (data) {
                alert("S");
            });
        },
        payyearly: function payyearly() {

            Nova.request().post('/nova-vendor/payments/payyearly').then(function (data) {
                alert("P");
            });
        }
    }
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Payments")]),
      _vm._v(" "),
      _c(
        "card",
        {
